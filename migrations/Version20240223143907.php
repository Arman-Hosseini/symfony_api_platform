 ...
 */
final class Version20240223143907 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "user" (id INT NOT NULL, company_id INT DEFAULT NULL, name VARCHAR(100) NOT NULL, email VARCHAR(180) NOT NULL, role TEXT NOT NULL, password VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
